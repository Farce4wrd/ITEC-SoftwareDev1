...
public class CharacterEntry {
    ...
    /** Method: main
     * Entry point for the GameCharacter program
     * Allows the user to enter as many characters as desired
     * and calls for them to be stored.
    ...
    /** Method: entry
     * Allows the user to enter the character information.
    ...
    /** Method: enterName
     * Allows the user to enter the character name.
     * Handles the GameDataException if an invalid name entered.
     */
    ...
    /** Method: enterType
     * Allows the user to enter the character type.
     * Handles the GameDataException if an invalid name entered.
    ...
    /** Method: enterHP
     * Allows the user to enter the character hit points.
     * Handles the GameDataException if an invalid name entered.
     * @param gc the GameCharacter that is being created.
     */
    ...
    /** Method: enterAC
     * Allows the user to enter the character armor class.
     * Handles the GameDataException if an invalid name entered.
     * @param gc the GameCharacter that is being created.
     */
