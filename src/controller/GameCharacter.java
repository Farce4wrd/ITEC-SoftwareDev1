...
public class GameCharacter {
	...
	private static CharacterStore cs; //remember cs is static. This is to share data/attributes of cs object/instance.
	...
	public void setType(String type) throws GameDataException{
		...
		switch(type.toUpperCase()) {
			default: throw new GameDataException("Unknown Type. Type must be "+ "Fighter, Wizard, Warrior, or Cleric");
			case "FIGHTER", "WIZARD","WARRIOR","CLERIC": break;	
		}
		this.type = type;
	}
	...
	public void setHp(int hp) throws GameDataException{
		if(hp<0 || hp>100) {
			throw new GameDataException("Hit points must be between 0 and 100 "+"inclusively");
		}
		this.hp=hp;
	}
	...
	/*
	 * This method is going to return all of characters in the CharacterStore
